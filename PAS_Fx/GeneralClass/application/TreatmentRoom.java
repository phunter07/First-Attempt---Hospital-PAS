...
public class TreatmentRoom {
	...
	public Date getTimeOutOfTreatmentRoom() {
		timeOutOfTreatmentRoom.setTime(timeInTreatmentRoom.getTime()+TimeUnit.MINUTES.toMillis(Constants.TIME_IN_TREATMENT_ROOM));
	...
	public void allocateExtraTime(){
		...
		timeOutOfTreatmentRoom.setTime(timeOutOfTreatmentRoom.getTime() + TimeUnit.MINUTES.toMillis(Constants.EXTENDED_TIME));
